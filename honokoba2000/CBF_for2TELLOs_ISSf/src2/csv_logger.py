...
def init_csv_logger():
    ...
    try:
        ...
        control_csv_writer.writerow([
            ...
            # CBF関連列（仕様書準拠）
            'cbf_fire_flag', 'rc_safe_x', 'rc_safe_z', 'rc_diff_norm',
            'qp_status', 'active_constraint_id',
            # CBF数学的値
            'rc_nom_x', 'rc_nom_z', 'h_x', 'HOh_x',
            # CBF速度差制約（h2, h3）
            'h2_value', 'h2_satisfied', 'h3_value', 'h3_satisfied',
            'velocity_diff_x', 'velocity_diff_y'
...
def log_control_data(drone_index, mode, mocap_position, target_position, error, rc_values, 
                    ...
                    # CBF関連パラメータ（仕様書準拠）
                    cbf_fire_flag=False, rc_safe_x=None, rc_safe_z=None, rc_diff_norm=None,
                    qp_status=None, active_constraint_id=None,
                    # CBF数学的値
                    rc_nom_x=None, rc_nom_z=None, h_x=None, HOh_x=None,
                    # CBF速度差制約（h2, h3）
                    h2_value=None, h2_satisfied=None, h3_value=None, h3_satisfied=None,
                    velocity_diff_x=None, velocity_diff_y=None):
    """
    制御データをCSVファイルに記録
