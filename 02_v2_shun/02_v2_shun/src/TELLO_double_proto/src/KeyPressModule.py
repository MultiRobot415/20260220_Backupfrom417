...
def init():
    ...
    text3 = font.render("W/S: 前進/後退, A/D: 左右移動", True, (0, 0, 0))
    text4 = font.render("↑/↓: 上昇/下降, ←/→: 左右回転", True, (0, 0, 0))
    text5 = font.render("ESC: 緊急停止", True, (0, 0, 0))
...
def getKey(keyName):
    ...
    try:
        ...
        if keyInput[myKey]:
            ...
            text4 = font.render("↑/↓: 上昇/下降, ←/→: 左右回転", True, (0, 0, 0))
            text5 = font.render("ESC: 緊急停止", True, (0, 0, 0))
            text6 = font.render(f"キー入力: {keyName}", True, (255, 0, 0))
            win.blit(text1, (50, 50))
            win.blit(text2, (50, 100))
            win.blit(text3, (50, 150))
            win.blit(text4, (50, 200))
