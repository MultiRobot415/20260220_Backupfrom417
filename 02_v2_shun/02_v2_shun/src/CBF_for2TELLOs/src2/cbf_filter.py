...
class CBFParams:
    def __init__(self, K1=0.009, K2=0.009, alpha1=1.0, alpha2=1.0, alpha3=1.0, 
                 alpha4=1.0, alpha5=1.0, Delta=0.4, v_ref=0.01,
...
def enforce_cbf(u_nom: Tuple[float, float],
    ...
    if use_velocity_constraints:
        x_dot_j, y_dot_j = other_velocity
        a2, b2 = velocity_diff_constraint_x(x_dot, x_dot_j, params)
        a3, b3 = velocity_diff_constraint_y(y_dot, y_dot_j, params)
        velocity_diff_x = x_dot - x_dot_j
        velocity_diff_y = y_dot - y_dot_j
    else:
        a2, b2 = None, None
        a3, b3 = None, None
        velocity_diff_x = 0.0
    ...
    h2_value = float(a2 @ u + b2) if use_velocity_constraints else 0.0
    h3_value = float(a3 @ u + b3) if use_velocity_constraints else 0.0
