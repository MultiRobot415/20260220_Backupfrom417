...
def get_rigid_body_position(rigid_body_id):
    """
    get_current_position関数へのエイリアス - 互換性のため
    :param rigid_body_id: 取得したいリジッドボディのID
    :return: 位置データの辞書 {"x": x, "y": y, "z": z}
    """
    return get_current_position(rigid_body_id)
