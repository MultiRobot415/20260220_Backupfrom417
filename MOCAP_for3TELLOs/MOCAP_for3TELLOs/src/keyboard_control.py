...
def init():
    ...
    # ウィンドウを作成
    _win = pygame.display.set_mode((800, 450))  # 高さを増やして新しいテキスト行を追加
    ...
    try:
        ...
        text7 = font.render("T-Mode Position Control: G:Forward B:Back V:Left N:Right", True, (0, 128, 0))
        ...
        _win.blit(text7, (20, 300))  # 新しいテキスト行を追加
        _win.blit(text5, (20, 350))  # 位置を調整
